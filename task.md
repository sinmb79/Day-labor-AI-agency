...
- [ ] Setup `code/contracts` (Hardhat Environment)
...
- [ ] Compile & Deploy MockToken (LABORAI)
- [ ] Compile & Deploy MockEscrow
- [ ] Create wrapper scripts to interact with contracts locally
...
- [ ] Automate the flow described in `DEMO_SCENARIO.md`
- [ ] Verify complete E2E flow
